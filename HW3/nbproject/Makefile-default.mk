...
SOURCEFILES_QUOTED_IF_SPACED=i2c_master_noint.c i2c_main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/i2c_master_noint.o ${OBJECTDIR}/i2c_main.o
POSSIBLE_DEPFILES=${OBJECTDIR}/i2c_master_noint.o.d ${OBJECTDIR}/i2c_main.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/i2c_master_noint.o ${OBJECTDIR}/i2c_main.o

# Source Files
SOURCEFILES=i2c_master_noint.c i2c_main.c
...
${OBJECTDIR}/i2c_main.o: i2c_main.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/i2c_main.o.d 
	@${RM} ${OBJECTDIR}/i2c_main.o 
	@${FIXDEPS} "${OBJECTDIR}/i2c_main.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG   -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/i2c_main.o.d" -o ${OBJECTDIR}/i2c_main.o i2c_main.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -mdfp=${DFP_DIR}  
...
${OBJECTDIR}/i2c_main.o: i2c_main.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/i2c_main.o.d 
	@${RM} ${OBJECTDIR}/i2c_main.o 
	@${FIXDEPS} "${OBJECTDIR}/i2c_main.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/i2c_main.o.d" -o ${OBJECTDIR}/i2c_main.o i2c_main.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -mdfp=${DFP_DIR}  
